...
$bill_details = $billinfo[0];
 ?>
<a href=""><span><img style="background-color:black;margin-top: -5px;"src="{{ asset('dist/img/logo-sidebar.png') }}" width="12%"></span></a><h2>Mangaluru City Corporation - Water Bill</h2>
